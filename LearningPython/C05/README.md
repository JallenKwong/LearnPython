...
[1.Python的数字类型](#python的数字类型)

[1.1.数字常量](#数字常量)

[1.2.内置数学工具和扩展](#内置数学工具和扩展)

[1.3.Python表达式操作式](#python表达式操作式)

[2.在实际应用中的数字](#在实际应用中的数字)

[2.1.变量和基本的表达式](#变量和基本的表达式)

[2.2.数字显示的格式](#数字显示的格式)

[2.3.比较：一般的和连续的](#比较一般的和连续的)

[2.4.str和repr显示格式](#str和repr显示格式)

[2.5.除法：传统除法、Floor除法和真除法](#除法传统除法floor除法和真除法)

[2.6.整数精度](#整数精度)

[2.7.复数](#复数)

[2.8.十六进制、八进制和二进制记数](#十六进制八进制和二进制记数)

[2.9.位操作](#位操作)

[2.10.其他的内置数学工具](#其他的内置数学工具)
...
- X / Y 传统除法和真除法。对于整数会省去小数部分，对于浮点数会保持小数部分
- X // Y 这个操作不考虑操作对象的类型，总会省略掉结果的小数部分，剩下最小的能整除的整数部分
